...
<head>
    ...
    <script type="text/javascript">
        ...
        function submit() {
            ...
            /*   $.ajax({
             url: "${pageContext.request.contextPath}/purchaser/update.html",
             type: "post",
             data:{} ,
             dataType: "json",
             success: function (data) {
...
<div class="container container_box" id="container1">
    ...
    <div>
        ...
        <ul class="ul_list">
            ...
            <li class="col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="input-append input_group col-sm-12 col-xs-12 p0">
                    <input type="text" class="input_group" id="referenceNo" name="referenceNo"
                           value="${list[0].referenceNo}">
                    <span class="add-on">i</span>
                </div>
            </li>
            <li class="col-md-3 col-sm-6 col-xs-12">
            ...
            <li class="col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="input-append input_group col-sm-12 col-xs-12 p0">
                    <input type="text" class="input_group" id="rec_mobile" name="mobile"
                           value="${list[0].recorderMobile }">
                    <span class="add-on">i</span>
                </div>
            </li>
            ...
            <li class="col-md-3 col-sm-6 col-xs-12">
                ...
                <u:upload id="detail" multiple="true" buttonName="上传附件" businessId="${fileId}" sysKey="2"
                          typeId="${typeId}" auto="true"/>
             ...
             <form   id="edit_form"  action="${pageContext.request.contextPath}/purchaser/update.html" method="post">
                 <c:forEach items="${list }" var="obj" varStatus="vs">
                     <tr style="cursor: pointer;">
                         ...
                         <td>&lt;%&ndash; <input type="text" name="list[0].department" value="${obj.department}"> &ndash;%&gt;
                             <div class="department">${obj.department}</div>
                                 &lt;%&ndash;  <c:forEach items="${requires }" var="re" >
                         ...
                         <td>
                                 &lt;%&ndash;       <c:if test="${obj.price!=null}"> &ndash;%&gt;
                             <input type="hidden" name="ss" value="${obj.id}"  >
                         ...
                         <td><input type="text" name="list[${vs.index }].isFreeTax" value="${obj.isFreeTax}" class="freetax"></td>
                             &lt;%&ndash;  <td><input type="text" name="list[${vs.index }].goodsUse" value="${obj.goodsUse}"></td>
                              <td><input type="text" name="list[${vs.index }].userUnit" value="${obj.userUnit}"></td> &ndash;%&gt;
                         <td><div class="memo">${obj.memo}</div>
                         <td>
                                 &lt;%&ndash;  ${obj.id} &ndash;%&gt;
                                 &lt;%&ndash;  <div class="extrafile">
                             ...
                             &lt;%&ndash;
                              ...
                              <input type="hidden" name="list[${vs.index }].item" value="${obj.item }">
                                ...
                                <input type="hidden" name="list[${vs.index }].memo" value="${obj.memo }">&ndash;%&gt;
                             &lt;%&ndash;            <input type="hidden" name="list[${vs.index }].planName" value="${obj.planName }">
                                        ...
                                        <input type="hidden" name="list[${vs.index }].department" value="${obj.department}">  &ndash;%&gt;
                         </td>
